...
<?php
    $section_sql = "select c.description from Sections s join instructor i on i.instructor_id = s.instructor_id join Course c on c.CourseID= s.CourseID where i.instructor_id=" . $row["instructor_id"];
